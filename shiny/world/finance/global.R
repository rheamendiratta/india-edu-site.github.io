...
# ── Plot metadata ──────────────────────────────────────────────────────────────
PLOT_META <- list(
  EXP_GDP      = list(title="Govt Education Expenditure (% of GDP)",           y_label="% of GDP",                     has_levels=FALSE, wb_levels="Total",                                                  reverse_scale=FALSE, description="Government education expenditure as % of GDP. OECD average ~5%."),
  EXP_GOVTBDG  = list(title="Govt Education Expenditure (% of Total Govt)",    y_label="% of total govt expenditure",  has_levels=FALSE, wb_levels="Total",                                                  reverse_scale=FALSE, description="Education as % of total government expenditure."),
