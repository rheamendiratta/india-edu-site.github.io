...
# ── Plot metadata ──────────────────────────────────────────────────────────────
PLOT_META <- list(
  HCI      = list(title="Human Capital Index",                  y_label="Index value (0–1)",        level="Total",   has_gender=TRUE,  reverse_scale=FALSE, description="World Bank index (0–1) measuring human capital a child born today can expect by age 18."),
  ...
  LAYS     = list(title="Learning-Adjusted Years of Schooling", y_label="Learning-adjusted years",     level="Primary", has_gender=FALSE, reverse_scale=FALSE, description="Expected years of school discounted by learning quality."),
  ...
  HDI      = list(title="Human Development Index",              y_label="Index value (0–1)",        level="Total",   has_gender=FALSE, reverse_scale=FALSE, description="UNDP composite index combining health, education, and income (0–1)."),
